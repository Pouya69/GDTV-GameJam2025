...
public class Puzzle_Elevator : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        else if (Side_2.PlayerOnThisSide != null)
        {
            Vector3 PlayerLoc = Side_2.PlayerOnThisSide.CapsuleCollision.transform.position;
            PlayerLoc.y += Side_2_Loc.y - Side_2.movingObject.transform.position.y;
            Side_2.PlayerOnThisSide.CapsuleCollision.transform.position = PlayerLoc;
        }
